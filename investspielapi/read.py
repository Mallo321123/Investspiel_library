...
class read:
    def __init__(self, cookieconsent, ssid):
    ...
    def stock(self, name, time_range):
        self.stock_config.read('stock.conf')
    ...
    def price(self, name):
        url = self.generall_config["get"]["url1"] + self.generall_config["post"]["portfolioid"] + self.generall_config["get"]["url2"] + self.trade_config[name]["type"] + self.generall_config["get"]["url3"] + self.trade_config[name]["ticker"]
